...
agetab <- table(c(rep("Emily", 22), rep("Alex", 12), rep("Ross", 53), rep("Tyler", 65))) 

barplot(agetab) 

agetab2 <- agetab / sum(agetab) 
...
xnorm <- rnorm(5000,150,25)
hist(xnorm)
hist(xnorm,breaks=50)
...
contable <- matrix(c(22,62,18,31,19,43),ncol=2,byrow=TRUE)
colnames(contable)<-c("Men","Women")
rownames(contable)<-c("Online","In-store","Click and Collect")
