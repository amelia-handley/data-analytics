...
ggplot(dataset, aes(y=Part.B.Score, x=Completion.Time, color=Gender)) + geom_point() + facet_wrap(~Gender_f) + ylim(NA,100) + labs(title="Completion Time vs Participants Score for Test B", y="Participant Score for Part B (%)", x="Completion Time (s)") + theme(legend.position="none",panel.border = element_rect(color="grey", fill=NA, size=1), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), panel.background = element_blank(), axis.line = element_line(colour = "grey"), plot.title = element_text(hjust=0.5, face="bold"))
#GRAPH 5: WITH AGE
ggplot(dataset, aes(y=Part.B.Score, x=Completion.Time, color=Age.Band)) + geom_point() + facet_wrap(~Gender_f) + ylim(NA,100) + labs(title="Completion Time vs Participants Score for Test B", y="Participant Score for Part B (%)", x="Completion Time (s)") + scale_color_discrete(name="Age\nBand\nOf\nParticipants",limits=c("U","Y","M","O"),labels=c("Under 16", "Young Adult\n(16-39)\n", "Middle-Aged\n(40-64\n)", "Older Adult\n(65)")) + theme(panel.border = element_rect(color="grey", fill=NA, size=1), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), panel.background = element_blank(), axis.line = element_line(colour = "grey"), plot.title = element_text(hjust=0.5, face="bold"))
...
ggplot(dataset, aes(x=Age, y=Part.B.Score)) + geom_point(color="black", size=1.5) + labs(title="Participants Score for Test Part B vs Participant Age", y="Participant Score for Part B (%)", x="Age of Participant (Years)") + theme(panel.border = element_rect(color="grey", fill=NA, size=1), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), panel.background = element_blank(), axis.line = element_line(colour = "grey"), plot.title = element_text(hjust=0.5, face="bold"))
...
# Completion.Time vs Test B Score
ggplot(dataset, aes(y=Part.B.Score, x=Completion.Time, color=Age.Band)) + geom_point() + facet_wrap(~Gender_f) + ylim(NA,100) + labs(title="Completion Time vs Participants Score for Test B", y="Participant Score for Part B", x="Completion Time (s)") + theme(legend.position="none", panel.border = element_rect(color="grey", fill=NA, size=1), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), panel.background = element_blank(), axis.line = element_line(colour = "grey"), plot.title = element_text(hjust=0.5, face="bold"))
ggplot(dataset, aes(y=Part.B.Score, x=Completion.Time, color=Gender)) + geom_point() + facet_wrap(~Gender_f) + ylim(NA,100) + labs(title="Completion Time vs Participants Score for Test B", y="Participant Score for Part B (%)", x="Completion Time (s)") + theme(legend.position="none",panel.border = element_rect(color="grey", fill=NA, size=1), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), panel.background = element_blank(), axis.line = element_line(colour = "grey"), plot.title = element_text(hjust=0.5, face="bold"))
